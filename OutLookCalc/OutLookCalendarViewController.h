//
//  OutLookCalendarViewController.h
//  OutLookCalendar
//
...
@protocol OutLookCalendarViewDelegate;

/**
 *  `OutLookCalendarViewController` is a `UICollectionViewController` subclass that displays a scrollable calendar view inspired by iOS7 Apple Cal App.
 */
@interface OutLookCalendarViewController : UICollectionViewController <UICollectionViewDelegateFlowLayout>
 ...
 *  Must adopt the `OutLookCalendarViewDelegate` protocol.
 *
 *  @see OutLookCalendarViewDelegate
 */
@property (nonatomic, weak) id<OutLookCalendarViewDelegate> delegate;
...
/**
 *  The methods in `OutLookCalendarViewDelegate` are all optional. It allows the delegate to be notified when the user interacts with the Calendar.
 */
@protocol OutLookCalendarViewDelegate <NSObject>
 ...
 */
- (void)simpleCalendarViewController:(OutLookCalendarViewController *)controller didSelectDate:(NSDate *)date;
 ...
 */
- (BOOL)simpleCalendarViewController:(OutLookCalendarViewController *)controller shouldUseCustomColorsForDate:(NSDate *)date;
 ...
 *  @param date       the date (Midnight GMT)
 */
- (UIColor *)simpleCalendarViewController:(OutLookCalendarViewController *)controller circleColorForDate:(NSDate *)date;
 ...
 *  @param date       the date (Midnight GMT)
 */
- (UIColor *)simpleCalendarViewController:(OutLookCalendarViewController *)controller textColorForDate:(NSDate *)date;
