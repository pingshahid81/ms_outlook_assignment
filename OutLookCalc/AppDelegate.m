...
@interface AppDelegate () <OutLookCalendarViewDelegate>
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    OutLookCalendarViewController *calendarViewController = [[OutLookCalendarViewController alloc] init];
    ...
    [calendarViewController setTitle:@"OutLook Calender View"];
    [self.window setRootViewController:defaultNavController];
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"OutLookCalc"];
