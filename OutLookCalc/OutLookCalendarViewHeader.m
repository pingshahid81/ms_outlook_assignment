...
const CGFloat OutLookCalendarHeaderTextSize = 12.0f;

@implementation OutLookCalendarViewHeader
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [_titleLabel setFont:[UIFont systemFontOfSize:OutLookCalendarHeaderTextSize]];
