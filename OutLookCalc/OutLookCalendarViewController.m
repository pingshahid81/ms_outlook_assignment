//
//  OutLookCalendarViewController.m
//  OutLookCalendar
//
...
#import "OutLookCalendarViewController.h"
#import "OutLookCalendarViewFlowLayout.h"
#import "OutLookCalendarViewCell.h"
#import "OutLookCalendarViewHeader.h"


const CGFloat OutLookCalendarOverlaySize = 14.0f;

static NSString *OutLookCalendarViewCellIdentifier = @"com.producteev.collection.cell.identifier";
static NSString *OutLookCalendarViewHeaderIdentifier = @"com.producteev.collection.header.identifier";


@interface OutLookCalendarViewController () <OutLookCalendarViewCellDelegate>
...
@implementation OutLookCalendarViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    self = [super initWithCollectionViewLayout:[[OutLookCalendarViewFlowLayout alloc] init]];
    if (self) {
...
- (void)scrollToDate:(NSDate *)date animated:(BOOL)animated
{
    @try {
        ...
        if (![[self.collectionView indexPathsForVisibleItems] containsObject:selectedDateIndexPath]) {
            ...
            origin.x = 0;
            origin.y -= (OutLookCalendarFlowLayoutHeaderHeight + OutLookCalendarFlowLayoutInsetTop + self.collectionView.contentInset.top);
...
- (void)viewDidLoad
{
    ...
    [self.collectionView registerClass:[OutLookCalendarViewCell class] forCellWithReuseIdentifier:OutLookCalendarViewCellIdentifier];
    [self.collectionView registerClass:[OutLookCalendarViewHeader class] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:OutLookCalendarViewHeaderIdentifier];
    ...
    [self.overlayView setFont:[UIFont boldSystemFontOfSize:OutLookCalendarOverlaySize]];
    [self.overlayView setTextColor:self.overlayTextColor];
    ...
    NSDictionary *metricsDictionary = @{@"overlayViewHeight": @(OutLookCalendarFlowLayoutHeaderHeight)};
...
{
    OutLookCalendarViewCell *cell = [self.collectionView dequeueReusableCellWithReuseIdentifier:OutLookCalendarViewCellIdentifier
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
    if (kind == UICollectionElementKindSectionHeader) {
        OutLookCalendarViewHeader *headerView = [self.collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:OutLookCalendarViewHeaderIdentifier forIndexPath:indexPath];
...
- (OutLookCalendarViewCell *)cellForItemAtDate:(NSDate *)date
{
    return (OutLookCalendarViewCell *)[self.collectionView cellForItemAtIndexPath:[self indexPathForCellAtDate:date]];
}

#pragma mark OutLookCalendarViewCellDelegate

- (BOOL)simpleCalendarViewCell:(OutLookCalendarViewCell *)cell shouldUseCustomColorsForDate:(NSDate *)date
{
...
- (UIColor *)simpleCalendarViewCell:(OutLookCalendarViewCell *)cell circleColorForDate:(NSDate *)date
{
    if (![self isEnabledDate:date]) {
...
- (UIColor *)simpleCalendarViewCell:(OutLookCalendarViewCell *)cell textColorForDate:(NSDate *)date
{
    if (![self isEnabledDate:date]) {
